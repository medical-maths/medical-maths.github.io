...
```
[.Rmd file for this article](https://github.com/medical-maths/medical-maths.github.io/blob/main/statistical-paradoxes-in-medicine-i-the-false-positive-paradox.Rmd)

I thought I would use my first few posts on this site to explore some interesting [veridical](https://en.wikipedia.org/wiki/Paradox#Quine's_classification) paradoxes in medical statistics, starting with an example of the 'false positive paradox'. 
